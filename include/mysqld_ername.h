...
{ "ER_RDSADMIN_DELETED", 1714, "users witch configured in user_list_string can not to be deleted or updated." },
{ "ER_USER_TABLE_DROPPED", 1715, "table mysql.user can not to be truncated or dropped." },
{ "ER_BINLOG_UNSAFE_INSERT_IGNORE_SELECT", 1716, "INSERT IGNORE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_INSERT_SELECT_UPDATE", 1717, "INSERT... SELECT... ON DUPLICATE KEY UPDATE is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are updated. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_REPLACE_SELECT", 1718, "REPLACE... SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are replaced. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_CREATE_IGNORE_SELECT", 1719, "CREATE... IGNORE SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are ignored. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_CREATE_REPLACE_SELECT", 1720, "CREATE... REPLACE SELECT is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are replaced. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_UPDATE_IGNORE", 1721, "UPDATE IGNORE is unsafe because the order in which rows are updated determines which (if any) rows are ignored. This order cannot be predicted and may differ on master and the slave." },
{ "ER_PLUGIN_NO_UNINSTALL", 1722, "Plugin \'%s\' is marked as not dynamically uninstallable. You have to stop the server to uninstall it." },
{ "ER_PLUGIN_NO_INSTALL", 1723, "Plugin \'%s\' is marked as not dynamically installable. You have to stop the server to install it." },
{ "ER_CPU_TIMES_LIMITED", 1724, "User \'%s@%s\' CPU resource is exhausted." },
{ "ER_IO_READS_LIMITED", 1725, "User \'%s@%s\' IO resource is exhausted." },
{ "ER_TRX_CPU_TIMES_LIMITED", 1726, "User \'%s@%s\' CPU times of the TRX limited." },
{ "ER_TRX_IO_READS_LIMITED", 1727, "User \'%s@%s\' IO reads of the TRX limited." },
{ "ER_PROFILER_ACCESS_DENIED", 1728, "Profile tables can\'t to be accessed by SQL." },
{ "ER_PROFILE_ALREADY_EXISTS", 1729, "Profile \'%s\' already exists." },
{ "ER_PROFILE_DOESNOT_EXIST", 1730, "Profile \'%s\' doesn\'t exist." },
{ "ER_ROLE_DOESNOT_EXIST", 1731, "Role \'%s\' doesn\'t exist." },
{ "ER_GRANT_ROLE_TO_USER", 1732, "grant role \'%s\' to user \'%s\'@\'%s\' WITH_CHECK_OPTION error, different \'%s\' privileges" },
{ "ER_BINLOG_UNSAFE_WRITE_AUTOINC_SELECT", 1733, "Statements writing to a table with an auto-increment column after selecting from another table are unsafe because the order in which rows are retrieved determines what (if any) rows will be written. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_CREATE_SELECT_AUTOINC", 1734, "CREATE TABLE... SELECT...  on a table with an auto-increment column is unsafe because the order in which rows are retrieved by the SELECT determines which (if any) rows are inserted. This order cannot be predicted and may differ on master and the slave." },
{ "ER_BINLOG_UNSAFE_INSERT_TWO_KEYS", 1735, "INSERT... ON DUPLICATE KEY UPDATE  on a table with more than one UNIQUE KEY is unsafe" },
{ "ER_TABLE_IN_FK_CHECK", 1736, "Table is being used in foreign key check." },
{ "ER_UNSUPPORTED_ENGINE", 1737, "Storage engine \'%s\' does not support system tables. [%s.%s]" },
{ "ER_BINLOG_UNSAFE_AUTOINC_NOT_FIRST", 1738, "INSERT into autoincrement field which is not the first part in the composed primary key is unsafe." },
{ "ER_COL_COUNT_DOESNT_MATCH_CORRUPTED_V2", 1739, "Column count of %s.%s is wrong. Expected %d, found %d. The table is probably corrupted" },
{ "ER_RPL_INFO_DATA_TOO_LONG", 1740, "Data for column \'%s\' too long" },
{ "ER_CANT_LOCK_RPL_INFO_TABLE", 1741, "You can\'t use locks with rpl info tables." },
{ "ER_CHANGE_SLAVE_PARALLEL_THREADS_ACTIVE", 1742, "Cannot change @@slave_parallel_threads while another change is in progress" },
